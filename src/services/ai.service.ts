...
[RESERVA_TRIGGER] {"nombre": "Juan", "telefono_contacto": "3001234567", "fecha": "2024-10-15 14:00", "personas": 4, "zona": "Cosmos 105", "decoracion": "Bouquet plus", "mesero": "Si", "abono": "50000", "observacion": "Cumpleaños, pre-orden: 2 pollos, alérgico al maní, silla de ruedas"}
  (Nota: Debes llenar todos los campos del JSON. En el campo "observacion" debes incluir TODA la información extra de la reserva, como pre-órdenes de comida, motivos especiales, alergias y requerimientos adicionales. Si requiere abono, envíale los datos de pago [ENVIAR_DATOS_PAGO] Y en ese MISMO mensaje debes incluir obligatoriamente el [RESERVA_TRIGGER]).
